...
However, questions have been raised about whether this is actually the physical process responsible for the extra mixing. In particular, reproducing the observed amounts of mixing in this regime requires much higher efficiency parameters than most fluid simulations would suggest are reasonable or physical %[AF to MJ: I have changes to suggest before approving this, but first see my comment at end of this paragraph]  
