...
%
while the other three employ the \citet{kippenhahn_etal_1980} prescription with coefficients $\alpha_{\rm th} \in [0.1, 2, 700]$. %\blu{(see Section \ref{sec:parameterizations} for more details of these prescriptions)}. 
...
%, meaning the timescale for homogenization of the mixing zone is large.
...
%\sout{(see Figure \ref{fig:parameterization_compare}} \textcolor{red}{[missing close paren? -AF]} 
...
%\sout{in simulations of the propagation of salt fingers in water} 
