...
There is particularly high qualitative similarity between the Brown model and Kippenhahn model with $\alpha_{\text{th}} = 2$\red{, which represent the default stellar calibrations of each theory}. 
