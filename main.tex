...
% \title{Observed Extra Mixing in Red Giants Scales with the Reduced Density Ratio in Thermohaline Mixing Models}
...
%\textbf{[NOT DONE JT has implemented EA. and much of MC]}
%Enhanced extra mixing in low-mass upper giant branch stars has been well documented for decades. 
...
\section{Stellar Evolution Models \textbf{(CYCLE DONE)}} %MC changed this from 'Mesa Configuration'
