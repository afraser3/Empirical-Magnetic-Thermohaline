...
\affiliation{Kavli Institute for Theoretical Physics, University of Santa Barbara, California, 93106, USA}
...
\section{Results from Numerical Experiments \textbf{(RTR)}}
%previously called ``1D calculations of stellar R0:Meridith"
\label{sec:mesa_results}
\input{sec_mesa_results}

\section{Observed Mixing Signatures \bf({RTR})}
\label{sec:obs}
\input{sec_observations}

\section{Results \bf{RTR}} 
\label{sec:punchline}
\input{sec_punchline}
...
The first four authors of this manuscript contributed equally to this work. A. Fraser did X; M. Joyce did Y; E. Anders did Z, J. Tayar was responsible for all analysis related to observations as well as the construction of the intial manuscript template. Author order within this set was decided according to height in heels, descending.   
...
{\color{red}Adrian thank Pascale for discussions on thermohaline mixing that helped improve your understanding.}
